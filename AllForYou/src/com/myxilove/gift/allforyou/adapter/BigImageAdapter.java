...
public class BigImageAdapter extends BaseAdapter {
	...
	public BigImageAdapter(ListViewFragment fg, CodeClass[] imageUrls,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		holder.textView.setTypeface(BaseApplication.chineseTypeface);
		imageLoader.displayImage(imageUrls[position% imageUrls.length].getKey(),
