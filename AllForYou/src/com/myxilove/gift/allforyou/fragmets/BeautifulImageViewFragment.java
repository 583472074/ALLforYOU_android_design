...
import org.myxilove.util.view.MyViewpager;

import com.myxilove.dribbb.animation.DepthPageTransformer;
import com.myxilove.gift.allforyou.R;
import com.myxilove.gift.allforyou.adapter.MyImageViewpagerAdapter;
...
public class BeautifulImageViewFragment extends Fragment {
	...
	private void initViewpager(View view) {
		...
		textView1.setTypeface(BaseApplication.englishTypeface);
		textView.setText("/" + count);
		textView.setTypeface(BaseApplication.englishTypeface);
