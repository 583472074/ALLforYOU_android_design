...
import com.myxilove.gift.allforyou.activities.BeautifulImageViewActivity;
...
public class MyGridPicAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = mInflater.inflate(R.layout.own_gird_layout, null);
		...
		imageLoader.displayImage(listData[position].getKey(),
