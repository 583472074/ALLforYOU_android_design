/*
 * $Id: JSONReader.java,v 1.1 2013/05/20 02:43:39 33320 Exp $
 *
...
class JSONReader {
	...
	private Object number() {
		...
		if (this.buf.indexOf(".") >= 0) {
			return new Double(Double.parseDouble(this.buf.toString()));

		} else
			return new Long(Long.parseLong(this.buf.toString()));
	}
